...
export default function EnhancedProductsTable({ products = mockProducts, loading = false }: EnhancedProductsTableProps) {
      ...
      <CardHeader>
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <CardTitle className="text-xl font-semibold">
            Τα Προϊόντα μου ({filteredProducts.length})
          </CardTitle>
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-4">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border border-secondary-300 rounded-lg text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 touch-manipulation"
              style={{ fontSize: '16px' }}
            />
          </div>
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <Button variant="ghost" size="sm" asChild>
                        <Link href={`/producer/products/${product.id}/edit`}>
            ...
            >
              <div className="flex items-start gap-3">
                <div className="h-16 w-16 flex-shrink-0 relative">
                  ...
                  {product.featured && (
                    <div className="absolute -top-1 -right-1 h-4 w-4 bg-primary-500 rounded-full"></div>
                  )}
                </div>
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-secondary-500 mt-1">{product.category}</p>
